...
test("renderer emits Git-tree topology, signal window, and terse cards", () => {
  ...
  assert.match(svg, /#D96459/);
  assert.match(svg, /#D8A23B/);
  assert.match(svg, /#4D9B6F/);
  ...
  assert.match(svg, /stroke="#2F6E78"/);
  assert.match(svg, /stroke="#75677D"/);
  assert.match(svg, /stroke="#A9773E"/);
  ...
  assert.match(svg, /fill="#F0F7F6" stroke="#9CB6B3"/);
  assert.match(svg, /stroke="#D8DAD5" stroke-width="1"/);

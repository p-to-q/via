...
test("renderer emits Git-tree topology, signal window, and terse cards", () => {
  ...
  assert.match(svg, /<text x="16" y="67" class="cost">60k–140k/);
  assert.match(svg, /<text x="16" y="87" class="meta" fill="#247C78">6–14 min<\/text>/);
...
test("CLI supports help, version, and validate", () => {
  ...
  assert.match(version.stdout, /^0\.3\.10/);
